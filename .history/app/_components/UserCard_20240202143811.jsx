  ...
  return (
    <div>
      <div className="m-1 p-5 bg-white text-black rounded-3xl">
        ...
        <div className="grid grid-cols-3 gap-2   justify-between w-[100%] mx-auto my-2 outline-dashed">
          <div className="bg-[#FFF5E9] w-40 lg:w-[110px] h-[60px] lg:h-[59px] rounded-xl flex flex-row gap-2">
            <Image
              src={userTick}
              width={24}
              height={24}
          ...
          <div className="bg-[#FFF5E9] w-40 lg:w-[110px] h-[60px] lg:h-[59px] rounded-xl flex flex-row gap-3">
            <Image
              src={magic}
              width={24}
              height={24}
        ...
        <button className="w-full h-[48px] bg-gradient-to-r from-red-500 via-red-600 to-orange-500 text-white px-4 py-2 rounded-xl">Follow</button>
      </div>
    </div>
  );
};
