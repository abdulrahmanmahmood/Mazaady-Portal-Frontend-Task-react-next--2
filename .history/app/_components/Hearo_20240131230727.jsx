    ...
    <section className="m-1 flex flex-col">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row gap-3 ">
          <button className=" w-40 h- border  rounded-2xl bg-[#FFF5E9] text-[#FF951D] border-[#FF951D]">
            Products
          </button>
          <button className="p-2 w-40 h- border  rounded-2xl text-[#ac9696]">
            Actions
          </button>
          <button className="p-2 w-40 h- border  rounded-2xl text-[#828282]">
            Reviews
          </button>
        </div>
