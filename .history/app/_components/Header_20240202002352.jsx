...
const Header = () => {
  ...
  return (
    <header className={`flex bg-white w-full my-auto overflow-hidden lg:justify-between ${isMenuVisible ? 'h-auto' : 'h-[68px]'}`}>
    ...
    <div className="items-center my-auto relative flex gap-1 ">
      ...
      <ul
        className={`lg:flex ml-[100px] items-center gap-9 overflow-hidden transition-all duration-500 max-h-[500px] opacity-0 lg:opacity-100 ${
          isMenuVisible ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0 lg:opacity-100'
        }`}
      >
      ...
      <div className="ml-auto pr-4 my-auto flex gap-5  lg:mr-10">
        ...
        <Image
          ...
          width={60}
          height={20}
          className="hidden lg:block object-contain cursor-pointer"
          alt="frame"
        />
      </div>
    </header>
