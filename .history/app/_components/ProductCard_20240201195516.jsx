          ...
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="flex flex-col lg:flex-row ">
              ...
              <div className="gird grid-cols-3 gap-3">
                {" "}
                <button className="bg-[#FFF5E9] w-12 lg:w-30 lg:h-15 rounded-3xl">
                  2 Days
                </button>
                <button className="bg-[#FFF5E9] w-12 lg:w-30 h-15 rounded-3xl">
                  {" "}
                  15 Hours
                </button>
                <button className="bg-[#FFF5E9] w-12 lg:w-30 h-15 rounded-3xl text-nowrap">
                  {" "}
                  50 Minutes
                </button>{" "}
              </div>
