        ...
        <div className=" lg:w-full">
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1  gap-1">
              ...
              <div className="grid grid-cols-3   gap-4 text-[#FF951D] justify-between">
                <button className="bg-[#FFF5E9] w-auto lg:w-30 p-1 lg:h-15 rounded-14  w-[100px] inline-flex items-center">
                  2 <span className="text-xs ">Days</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-14  w-[100px] inline-flex items-center">
                  15 <span className="text-xs inline-block">Hours</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-14 text-nowrap w-[100px]">
