        ...
        <div className=" lg:w-full">
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="flex flex-col lg:flex-row ">
              ...
              <div className="gird grid-cols-3 gap-4 text-[#FF951D]">
                {" "}
                <button className="bg-[#FFF5E9] lg:w-30 p-.5 lg:h-15 rounded-3xl">
                  2 <span className="text-xs">Minutes</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-.5 h-15 rounded-3xl">
                  {" "}
                  15 <span className="text-xs">Hours</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-.5 h-15 rounded-3xl text-nowrap">
                  {" "}
