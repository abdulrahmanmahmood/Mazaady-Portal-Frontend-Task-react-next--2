  ...
  return (
    <div className=" relative ">
      <div className="flex flex-row gap-5 lg:gap-20 relative m-3 p-3">
        <div className=" outline-dotted relative h-[80%] lg:h-auto ">
          <Image
            src={product.image}
            width={140}
            height={140}
          ...
          />
          {product.liveAuction ? (
            <div className="text-white text-nowrap w-[80%] h-9 rounded-tl-3xl rounded-br-3xl bg-[#D20653] absolute bottom-0 right-0 text-c">
              LIve Auction
            </div>
          ) : (
