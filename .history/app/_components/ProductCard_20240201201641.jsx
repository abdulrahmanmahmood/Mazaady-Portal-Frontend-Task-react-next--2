          ...
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="flex flex-col lg:flex-row  outline-dotted  ">
              ...
              <div className="grid grid-cols-3  outline-dashed gap-4 text-[#FF951D] justify-between">
                {" "}
                <button className="bg-[#FFF5E9] w-auto lg:w-30 p-1 lg:h-15 rounded-14 flex-row">
                  2 <span className="text-xs ">Days</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-14 w-auto flex-row">
                  {" "}
                  15 <span className="text-xs">Hours</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-14 text-nowrap w-auto flex-row">
                  {" "}
