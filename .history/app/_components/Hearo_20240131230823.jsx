    ...
    <section className="m-1 flex flex-col">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row gap-3 items-center">
          <button className=" w-40 h-10 border  rounded-2xl bg-[#FFF5E9] text-[#FF951D] border-[#FF951D]">
            Products
          </button>
          <button className="p-2 w-40 h-10 border  rounded-2xl text-[#ac9696]">
            Actions
          </button>
          <button className="p-2 w-40 h-10 border  rounded-2xl text-[#828282]">
            Reviews
          </button>
        </div>
        <button className="m-3 hidden lg:block justify-between px-1 py-1 bg-gradient-to-r from-red-600 via-orange-500 to-orange-400 h-16 rounded-xl">
