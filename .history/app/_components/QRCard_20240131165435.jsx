...
const QRCard = () => {
  return (
    <div className=" m-1 p-5 bg-white text-black rounded-3xl w-full">
      <div className="flex flex-col ">
        ...
        <div className=" w-[311px] lg:w-full mx-auto bg-[#FFF5E9]  rounded-lg m-3 flex gap-3 items-center">
          <Image src={Download2} width={24} height={24} alt="Download2" className="object-contain"/>
          <p className="font-normal text-base">Download the QR code or share it with your friends.</p>
        </div>
