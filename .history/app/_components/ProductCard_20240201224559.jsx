    ...
    <div className=" relative ">
      <div className="flex flex-row gap-5 lg:gap-20 relative m-2 p-3">
        <div className="  relative h-[80%] lg:h-auto ">
          ...
          />
          {product.liveAuction ? (
            <div className="text-white text-nowrap w-[80%] h-9 rounded-tl-3xl rounded-br-3xl bg-[#D20653] absolute bottom-0 right-0 lg:bottom-7 lg:right-1 text-center  p-1">
              LIve Auction
            </div>
          ) : (
