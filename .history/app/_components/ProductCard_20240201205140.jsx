        ...
        <div className=" lg:w-full">
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1  gap-1">
              ...
              <div className="grid grid-cols-3 text-[#FF951D] justify-between outline-dotted">
                <button className="bg-[#FFF5E9]  lg:w-30 lg:h-15 rounded-14  w-[100px]  items-center">
                  2 <span className="text-xs ">Days</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30  h-15 rounded-14  w-[100px]  items-center">
