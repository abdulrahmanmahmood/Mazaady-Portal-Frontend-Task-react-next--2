    ...
    <div>
      <div className="m-1 p-5 bg-white text-black rounded-3xl">
        ...
        <div className="grid grid-cols-3 gap-2   justify-between w-[95%] mx-auto my-2">
          <div className="bg-[#FFF5E9] w-30 lg:w-[110px] h-[30px] lg:h-[59px] rounded-xl flex flex-row gap-2">
            <Image
              src={userTick}
              width={24}
              height={24}
          ...
          <div className="bg-[#FFF5E9] w-30 lg:w-[110px] h-[30px] lg:h-[59px] rounded-xl flex flex-row gap-3">
            <Image
              src={magic}
              width={24}
              height={24}
