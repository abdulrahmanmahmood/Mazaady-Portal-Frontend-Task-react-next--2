...
const UserCard = () => {
  ...
  <div className='flex flex-row  outline-dashed justify-between w-[90%] mx-auto my-2'>
    <div className='bg-[#FFF5E9] w-[100px] h-[59px] rounded-xl flex flex-row'>
      <Image src={userTick} width={24} height={24} alt='' className='obj'/>
    ...
    <div className='bg-[#FFF5E9] w-[100px] h-[59px] rounded-xl flex flex-row'>
      <Image src={profile2} width={24} height={24} alt='' className='obj'/>
      <div className='flex flex-col'>
        <h3></h3>
        <p></p>
      </div>
    ...
    <div className='bg-[#FFF5E9] w-[100px] h-[59px] rounded-xl flex flex-row'>
      <Image src={magic} width={24} height={24} alt='' className='obj'/>
      <div className='flex flex-col'>
        <h3></h3>
        <p></p>
      </div>
