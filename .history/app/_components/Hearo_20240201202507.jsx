...
const Hearo = () => {
  ...
  return (
    <section className="m-1 flex flex-col w-full outline-dashed">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row  lg:gap-3 items-center  w-full justify-between p-5">
          ...
          <button className=" w-40 h-10  hidden lg:block p-1 bg-gradient-to-r from-red-600 via-orange-500 to-orange-400 rounded-xl">
