...
<header className="flex bg-white h-[68px] w-full my-auto overflow-hidden lg:justify-between">
  <div className="lg:hidden items-center justify-center cursor-pointer">
    <Image
      src={menu}
      width={40}
      height={40}
  ...
  <div className="ml-auto pr-4 my-auto flex gap-5  lg:mr-10">
    ...
    <Image src={Frame} width={60} height={20} className="hidden lg:block object-contain cursor-pointer" alt="frame" />
  </div>
</header>
