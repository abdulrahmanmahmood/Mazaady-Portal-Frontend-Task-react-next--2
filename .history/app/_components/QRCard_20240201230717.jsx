  ...
  return (
    <div className=" mt-5 m-1 p-5 bg-white text-black rounded-3xl">
      <div className="flex flex-col ">
        ...
        <div className="mx-auto w-full p-6 bg-gradient-to-r from-red-500 via-red-600 to-orange-500 rounded-xl">
          <div className="p-1 bg-white flex flex-col items-center gap-2 rounded-2xl">
            <Image
              src={logo}
              width={150}
              height={50}
