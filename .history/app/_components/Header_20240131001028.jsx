...
<div className="lg:hidden items-center justify-center">
    <Image src={menu} width={100} height={43} alt="menu"  className="ml-[10px] my-auto" />

    </div>
  <div className="items-center my-auto relative flex gap-1 lg:gap-0">
    ...
    <div>
      ...
      <Image
        ...
        height={43}
        alt="logo"
        className="lg:ml-[84px] lg:mt-[12px] lg:my-auto ml-[3px]"
      />
    </div>
