...
<div className="mt-5 m-1 p-5 bg-white text-black rounded-3xl">
      <div className="flex flex-col ">
        ...
        <div className={` ease-in-out mx-auto w-full p-6 ${isHidden ? 'hidden' : 'block'} bg-gradient-to-r from-red-500 via-red-600 to-orange-500 rounded-2xl`}>
          <div className="p-2 bg-white flex flex-col items-center gap-2 rounded-2xl outline-dashed ">
            <Image
              src={logo}
              width={150}
              height={50}
