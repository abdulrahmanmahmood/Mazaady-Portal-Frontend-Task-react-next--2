  ...
  return (
    <section className="m-1 flex flex-col w-full ">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row  lg:gap-3 items-center justify-between">
          <button className=" w-30 lg:w-40 h-10 border  rounded-2xl bg-[#FFF5E9] text-[#FF951D] border-[#88817a]">
            Products
          </button>
