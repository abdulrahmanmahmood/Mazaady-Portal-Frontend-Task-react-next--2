    ...
    <div className=" relative ">
      <div className="flex flex-row gap-5 lg:gap-20 relative m-3 p-3">
        <div className="  relative h-[80%] lg:h-auto ">
          ...
          />
          {product.liveAuction ? (
            <div className="text-white text-nowrap w-[80%] h-9 rounded-tl-3xl rounded-br-3xl bg-[#D20653] absolute bottom-0 right-0 lg:bottom-5 text-center">
              LIve Auction
            </div>
          ) : (
            <div className="w-[80%] h-9 rounded-tl-3xl rounded-br-3xl bg-[#FF951D] absolute bottom-0 right-0 lg:bottom-5">
              Hot Sale{" "}
            </div>
          )}
        </div>
          ...
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-1  gap-1">
              ...
              <div className="flex space-x-2 lg:grid lg:grid-cols-3 text-[#FF951D] justify-between ">
                <button className="bg-[#FFF5E9] w-30 h-15 rounded-20 lg:rounded-full items-center">
                  2 <span className="text-xs">Days</span>
                </button>
                <button className="bg-[#FFF5E9] w-30 h-15 rounded-20 lg:rounded-full items-center">
                  15 <span className="text-xs inline-block">Hours</span>
                </button>
                <button className="bg-[#FFF5E9] w-30 h-15 rounded-20 lg:rounded-full text-nowrap">
