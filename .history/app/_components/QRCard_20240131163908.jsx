  ...
  return (
    <div className=" m-1 p-5 bg-white text-black rounded-3xl">
      <div className="flex flex-col ">
        <div className=" p-3 bg-white outline-dotted flex flex-row items-center justify-between">
          <h3 className="text-[18px] text leading-23 font-semibold font-nunito">QR Code</h3>
          <div className="flex flex-row gap-3 lg:gap-5 outline-dashed items-center">
            <button>
