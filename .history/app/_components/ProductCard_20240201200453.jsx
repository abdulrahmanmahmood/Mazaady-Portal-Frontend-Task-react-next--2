      ...
      <div className="flex flex-row gap-5 lg:gap-20 relative m-3 p-3">
        ...
        <div className=" lg:w-full">
          <div className="flex flex-col  h-full justify-between w-full">
            ...
            <div className="flex flex-col lg:flex-row  outline-dotted  ">
              <div>Lot Starts in</div>
              <div className="flex flex-row  outline-dashed gap-4 text-[#FF951D] justify-between">
                {" "}
                <button className="bg-[#FFF5E9] lg:w-30 p-1 lg:h-15 rounded-3xl ">
                  2 <span className="text-xs line-clamp-1">Days</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-3xl">
                  {" "}
                  15 <span className="text-xs">Hours</span>
                </button>
                <button className="bg-[#FFF5E9] lg:w-30 p-1 h-15 rounded-3xl text-nowrap">
                  {" "}
