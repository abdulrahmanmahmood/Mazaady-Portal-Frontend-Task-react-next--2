...
const Header = () => {
  return (
<header className="static flex bg-white h-[68px] w-full my-auto overflow-hidden lg:justify-between">
  ...
  <div className="ml-auto my-auto flex gap-5  lg:mr-10">
    <ul className=" items-center  gap-9 flex ">
      <li>
        <Image src={searchIcon} width={24} height={24} alt="search" />
      </li>
      <li>
        <Image src={notify} width={24} height={24} alt="notification" />
      </li>
      <li>
        <Image src={avatar} width={40} height={40} alt="user-avatar" />
      </li>
    </ul>
    <Image src={btn} width={172} height={40} className="hidden lg:block" alt="button" />

    <Image src={Frame} width={67} height={20} className="hidden lg:block object-contain" alt="frame" />
  </div>
</header>
