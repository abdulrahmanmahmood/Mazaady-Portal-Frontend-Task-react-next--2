    ...
    <section className="m-1 flex flex-col w-full ">
      <div className="flex flex-row justify-between ">
        <div className="flex flex-row  lg:gap-3 items-center ">
          <button className="p-2 w-[25%] lg:w-40 h-10 border  rounded-2xl bg-[#FFF5E9] text-[#FF951D] border-[#88817a]">
            Products
          </button>
          <button className="p-2 w-[25%] lg:w-40 h-10 border  rounded-2xl text-[#ac9696]">
            Actions
          </button>
          <button className="p-2 w-[25%] lg:w-40 h-10 border  rounded-2xl text-[#828282]">
            Reviews
          </button>
        </div>
